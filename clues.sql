...
SELECT * FROM countries WHERE region = 'Southern Europe' AND population < 100000;
-- Answer: Vatican City State :  1000
-- ############
...
-- Write SQL query here
SELECT * FROM countrylanguages WHERE percentage = 100 AND language ='Italian';
-- Answer: SMR
...
countrycode = code
WHERE
region = 'South America' AND cities.name ILIKE 'Serra%';
